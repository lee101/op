//! Native utilities exported via N-API for the OpenPaths toolchain.
//!
//! # Overview
...
/// [`op_install_tokio_runtime`], which the JS loader calls once `dlopen` has
/// returned.
///
...
/// Guards [`op_install_tokio_runtime`] so the runtime is built at most once
...
pub fn op_install_tokio_runtime() {
	#[cfg(target_os = "windows")]
