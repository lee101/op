...
class Settings(BaseSettings):
    ...
    # opening a PR — continue" reminder prompts into the same op session.
    # Set to 0 to disable.
    task_completion_max_reminders: int = Field(2, alias="ROBOMP_TASK_COMPLETION_MAX_REMINDERS")
    op_command: str = Field("op", alias="ROBOMP_OMP_COMMAND")
    ...
    # complete cleanly; any still running after that get their op
