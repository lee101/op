...
import { smokeTestSyncWorker } from "@openpaths/stats/aggregator";
...
describe("smokeTestSyncWorker", () => {
	it("skips the worker spawn on darwin so op --smoke-test stays off the macOS abort surface", async () => {
