...
import { MODELS_DEV_PROVIDER_DESCRIPTORS, mapModelsDevToModels } from "@openpaths/catalog/provider-models";
 ...
 * `op --model amazon-bedrock/us-gov.…` fails model resolution even though
