...
import { createModelManager } from "@openpaths/catalog/model-manager";
import { syntheticModelManagerOptions } from "@openpaths/catalog/provider-models/openai-compat";
