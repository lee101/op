...
import { getOAuthProviders } from "@openpaths/ai/registry/oauth";
import { getEnvApiKey } from "@openpaths/ai/stream";
import { getBundledModelReferenceIndex } from "@openpaths/catalog/identity/bundled";
import { resolveModelReference } from "@openpaths/catalog/identity/reference";
import type { ProviderCatalogEntry } from "@openpaths/catalog/provider-models/descriptor-types";
import {
	CATALOG_PROVIDERS,
	DEFAULT_MODEL_PER_PROVIDER,
	PROVIDER_DESCRIPTORS,
} from "@openpaths/catalog/provider-models/descriptors";
import {
	MODELS_DEV_PROVIDER_DESCRIPTORS,
	siliconflowCnModelManagerOptions,
	siliconflowModelManagerOptions,
} from "@openpaths/catalog/provider-models/openai-compat";
import type { FetchImpl } from "@openpaths/catalog/types";
