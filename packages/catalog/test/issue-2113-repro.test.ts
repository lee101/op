/**
 * Issue #2113 — `kimik2 does not work on the latest op`
 *
...
import { type OpenAICompletionsOptions, streamOpenAICompletions } from "@openpaths/ai/providers/openai-completions";
import type { AssistantMessage, Context } from "@openpaths/ai/types";
...
import { moonshotModelManagerOptions } from "@openpaths/catalog/provider-models/openai-compat";
