...
// `agent_context_usage` (claude_opus_4_8 observed at 1_000_000), but OP's context
...
const ProjectRootNamespaceQuery = `query op_gitlabDuoWorkflowProjectRootNamespace($fullPath: ID!) {
...
export function buildGitLabDuoWorkflowModelSpec(
	...
	return {
		...
		// is off — this also hides OP's thinking-effort selector for these models.
		reasoning: false,
		input: ["text"],
