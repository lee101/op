...
Model catalog for [openpaths](https://github.com/lee101/op): bundled model database, provider discovery, model identity, classification, and equivalence.
...
Import from subpaths (`@openpaths/catalog/<module>`) or the root barrel.
