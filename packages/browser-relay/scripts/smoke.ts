/**
 * Manual end-to-end smoke for the relay: replicates the op browser tool's
...
/** Puppeteer keeps the CDP target id on an internal field; same access the op tab supervisor uses (`targetIdForPage`). */
