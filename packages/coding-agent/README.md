...
- [Monorepo README (GitHub)](https://github.com/lee101/op#readme)
...
The agent supports three mutually-exclusive memory backends, selected via the `memory.backend` setting (Settings → Memory tab, or `~/.op/config.yml`):
