...
import { detectIndentFromContent, resolveFormatOptions } from "@openpaths/coding-agent/lsp/format-options";
import { getProjectDir, removeWithRetries, Snowflake, setProjectDir } from "@openpaths/utils";
