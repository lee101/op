...
import { resolveModels, runTinyModelsCommand } from "@openpaths/coding-agent/cli/tiny-models-cli";
import { TINY_LOCAL_MODELS } from "@openpaths/coding-agent/tiny/models";
...
describe("tiny-models download model resolution", () => {
	...
	it("prints actionable CUDA provider diagnostics from worker errors", async () => {
		...
		const diagnostic = [
			...
			"  side runtime: /home/user/.op/cache/tiny-title-runtime/transformers-test/node_modules",
