...
import { resolveCompressTargets, runCompressCommand } from "@openpaths/coding-agent/compress/index";
import { CompressProtocol } from "@openpaths/coding-agent/compress/protocol";
