...
import type { ModelRegistry, ProviderDiscoveryState } from "@openpaths/coding-agent/config/model-registry";
import { ModelRegistry as ModelRegistryImpl } from "@openpaths/coding-agent/config/model-registry";
