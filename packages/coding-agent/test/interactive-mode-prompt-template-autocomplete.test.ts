/**
 * Issue #2462: prompt templates discovered from `cwd/.op/prompts/` were never
...
import type { PromptTemplate } from "@openpaths/coding-agent/config/prompt-templates";
...
import type { AutocompleteProvider } from "@openpaths/tui";
