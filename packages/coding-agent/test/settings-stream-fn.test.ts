...
import type { Context, Model, SimpleStreamOptions } from "@openpaths/ai";
...
import { createSettingsAwareStreamFn } from "@openpaths/coding-agent/session/settings-stream-fn";
