...
import { BUILTIN_DEFAULTS_PROVIDER_ID, type Rule } from "@openpaths/coding-agent/capability/rule";
import { bucketRules } from "@openpaths/coding-agent/capability/rule-buckets";
