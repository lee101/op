...
import { LSP_STARTUP_EVENT_CHANNEL, type LspStartupEvent } from "@openpaths/coding-agent/lsp/startup-events";
...
import type { LspStartupServerInfo } from "@openpaths/coding-agent/tools";
