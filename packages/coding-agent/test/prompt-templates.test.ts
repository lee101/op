...
import { expandPromptTemplate, type PromptTemplate } from "@openpaths/coding-agent/config/prompt-templates";
import { expandSlashCommand, type FileSlashCommand } from "@openpaths/coding-agent/extensibility/slash-commands";
import { parseCommandArgs, substituteArgs } from "@openpaths/coding-agent/utils/command-args";
