...
import { renderWelcomeTip } from "@openpaths/coding-agent/modes/components/welcome";
import { initTheme, setTheme, theme } from "@openpaths/coding-agent/modes/theme/theme";
