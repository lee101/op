...
import { runOnboardingSetup } from "@openpaths/coding-agent/commands/setup";
...
import {
	...
	type SetupSceneHost,
	selectSetupScenes,
} from "@openpaths/coding-agent/modes/setup-wizard";
import { providersSetupScene } from "@openpaths/coding-agent/modes/setup-wizard/scenes/providers";
import { themeSetupScene } from "@openpaths/coding-agent/modes/setup-wizard/scenes/theme";
import { WebSearchTab } from "@openpaths/coding-agent/modes/setup-wizard/scenes/web-search";
import { SetupWizardComponent } from "@openpaths/coding-agent/modes/setup-wizard/wizard-overlay";
...
import { SEARCH_PROVIDER_OPTIONS, SEARCH_PROVIDER_ORDER } from "@openpaths/coding-agent/web/search/types";
...
describe("op setup onboarding trigger", () => {
