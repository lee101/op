...
import * as dapModule from "@openpaths/coding-agent/dap";
import { connectSocket, DapClient, waitForTcpServerListening } from "@openpaths/coding-agent/dap/client";
import { DapSessionManager } from "@openpaths/coding-agent/dap/session";
import type {
	DapCapabilities,
	DapClientState,
	DapEventMessage,
