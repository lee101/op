...
import { mergeMCPHeaders, setGeneratedHeader } from "@openpaths/coding-agent/mcp/transports/header-policy";
import { HttpTransport } from "@openpaths/coding-agent/mcp/transports/http";
