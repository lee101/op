...
import { ModelPickerComponent, type ModelPickerOptions } from "@openpaths/coding-agent/modes/components/model-picker";
import { resolveSegmentPalette } from "@openpaths/coding-agent/modes/components/segment-track";
