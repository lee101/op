 ...
 *
 * Regression: see https://github.com/lee101/op/issues/3646. Before the
...
import { EDIT_MODE_STRATEGIES } from "@openpaths/coding-agent/edit/streaming";
...
import { BUILTIN_DEFAULTS_PROVIDER_ID, type Rule, ruleCapability } from "@openpaths/coding-agent/capability/rule";
