...
import { HookEditorComponent } from "@openpaths/coding-agent/modes/components/hook-editor";
...
import { CURSOR_MARKER, isFocusable, setKeybindings, type TUI } from "@openpaths/tui";
