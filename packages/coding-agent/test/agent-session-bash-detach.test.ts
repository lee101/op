 ...
 * brush spawn). This test pulls the fix end-to-end through the OP coding
 * agent stack:
 *
 *   AgentSession.prompt
 *     → Agent.prompt (real)
 ...
 * SIGTTIN/SIGTTOU the OP host process.
 */
...
import { BashTool, type ToolSession } from "@openpaths/coding-agent/tools";
