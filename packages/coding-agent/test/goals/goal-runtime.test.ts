...
} from "@openpaths/coding-agent/goals/runtime";
import type { Goal, GoalModeState, GoalRuntimeEvent, GoalTokenUsage } from "@openpaths/coding-agent/goals/state";
import { escapeXmlText } from "@openpaths/utils";
