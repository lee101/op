...
import { ChatTranscriptBuilder } from "@openpaths/coding-agent/modes/components/chat-transcript-builder";
...
import type { SessionContext } from "@openpaths/coding-agent/session/session-context";
