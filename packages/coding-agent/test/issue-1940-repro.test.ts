...
import { SttClient } from "@openpaths/coding-agent/stt/asr-client";
import type { SttWorkerInbound, SttWorkerOutbound } from "@openpaths/coding-agent/stt/asr-protocol";
import { TinyTitleClient } from "@openpaths/coding-agent/tiny/title-client";
import type { TinyTitleWorkerInbound, TinyTitleWorkerOutbound } from "@openpaths/coding-agent/tiny/title-protocol";
