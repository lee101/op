...
import { getThemeByName, setThemeInstance, type Theme } from "@openpaths/coding-agent/modes/theme/theme";
import { sanitizeWithOptionalSixelPassthrough } from "@openpaths/coding-agent/utils/sixel";
