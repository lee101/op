...
import { applyExtensionFlags, type ExtensionFlagSink } from "@openpaths/coding-agent/cli/extension-flags";
import { buildInitialMessage } from "@openpaths/coding-agent/cli/initial-message";
...
import { normalizeContinueSessionArgs } from "@openpaths/coding-agent/main";
