...
import { ArtifactProtocolHandler } from "@openpaths/coding-agent/internal-urls/artifact-protocol";
...
import { resolveToolSearchScope } from "@openpaths/coding-agent/tools/path-utils";
