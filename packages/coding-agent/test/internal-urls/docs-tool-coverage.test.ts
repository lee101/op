...
import { BUILTIN_TOOL_NAMES } from "@openpaths/coding-agent/tools/builtin-names";

// Every shipped built-in tool that is exposed to the model in normal sessions
// must have a docs/tools/<name>.md root doc served by `op://`. File names use
...
describe("op:// root docs coverage", () => {
