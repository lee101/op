...
import {
	...
	parseAgentPluginMcp,
} from "@openpaths/coding-agent/discovery/agent-plugin-format";
import {
	clearClaudePluginRootsCache,
	injectPluginDirRoots,
	listClaudePluginRoots,
} from "@openpaths/coding-agent/discovery/helpers";
import { getPluginsDir, removeWithRetries } from "@openpaths/utils";
import "@openpaths/coding-agent/discovery/agent-plugins";
import "@openpaths/coding-agent/discovery/claude-plugins";
import type { MCPServer } from "@openpaths/coding-agent/capability/mcp";
