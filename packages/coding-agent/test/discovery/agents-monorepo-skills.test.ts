...
import { clearCache, readFile } from "@openpaths/coding-agent/capability/fs";
...
import { getProjectPathCandidates } from "@openpaths/coding-agent/discovery/agents";
import {
...
describe("agents provider project-level discovery", () => {
	...
	describe("skills", () => {
		...
		test("project walk-up skips home directory (no repo root)", async () => {
			// Regression for https://github.com/lee101/op/issues/1116:
