...
import { loadCapability, setDisabledProviders } from "@openpaths/coding-agent/capability";
import type { ContextFile } from "@openpaths/coding-agent/capability/context-file";
import { clearCache } from "@openpaths/coding-agent/capability/fs";
import type { Instruction } from "@openpaths/coding-agent/capability/instruction";
import type { Prompt } from "@openpaths/coding-agent/capability/prompt";
import { type Rule, resetActiveRulesForTests, setActiveRules } from "@openpaths/coding-agent/capability/rule";
import { RuleProtocolHandler } from "@openpaths/coding-agent/internal-urls/rule-protocol";
import { removeSyncWithRetries } from "@openpaths/utils";
import "@openpaths/coding-agent/capability/context-file";
import "@openpaths/coding-agent/capability/instruction";
import "@openpaths/coding-agent/capability/prompt";
import "@openpaths/coding-agent/capability/rule";
import "@openpaths/coding-agent/discovery/github";
