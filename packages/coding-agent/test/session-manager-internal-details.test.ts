...
import { type SkillPromptDetails, stripInternalDetailsFields } from "@openpaths/coding-agent/session/messages";
import type { CustomMessageEntry } from "@openpaths/coding-agent/session/session-entries";
