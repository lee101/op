...
import { renderSearchResult, type SearchRenderDetails } from "@openpaths/coding-agent/web/search/render";
import type { SearchResponse } from "@openpaths/coding-agent/web/search/types";
