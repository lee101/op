...
} from "@openpaths/coding-agent/web/search/provider";
import { __resetDirsFromEnvForTests, setAgentDir, TempDir } from "@openpaths/utils";
...
beforeEach(async () => {
	...
	setSearchProviderOrder([]);
	setExcludedSearchProviders([]);
	tempAgentDir = TempDir.createSync("@op-search-cli-");
