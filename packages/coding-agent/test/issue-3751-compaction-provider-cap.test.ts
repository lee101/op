/**
 * Regression for the [#3751](https://github.com/lee101/op/pull/3751)
...
import type { AgentMessage } from "@openpaths/agent-core/types";
...
import { wrapStreamFnWithProviderConcurrency } from "@openpaths/coding-agent/task/provider-concurrency";
