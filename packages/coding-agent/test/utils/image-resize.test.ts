...
import { resizeImage } from "@openpaths/coding-agent/utils/image-resize";
...
describe("resizeImage env wiring", () => {
	...
	it("treats OP_NO_WEBP=1 set at call time as exclusion (not baked at module load)", async () => {
		Bun.env.OP_NO_WEBP = "1";
