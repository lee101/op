...
import { AuthStorage, type CredentialDisabledEvent } from "@openpaths/ai";
import * as oauthUtils from "@openpaths/ai/oauth";
...
import type { Extension, ExtensionError, ExtensionFactory } from "@openpaths/coding-agent/extensibility/extensions";
import { ExtensionRunner } from "@openpaths/coding-agent/extensibility/extensions";
import { ExtensionRuntime } from "@openpaths/coding-agent/extensibility/extensions/loader";
...
describe("createAgentSession credential_disabled subscription", () => {
	...
	const baseOptions = (dirs: SessionDirs, authStorage: AuthStorage, extensions: ExtensionFactory[] = []) => ({
		...
		// loads the developer's real ~/.op models config on every construction (~100ms each,
