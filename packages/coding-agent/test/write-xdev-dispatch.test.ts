...
import { createTools, type Tool, type ToolSession } from "@openpaths/coding-agent/tools";
import { requiresApproval, resolveApproval } from "@openpaths/coding-agent/tools/approval";
import { githubToolRenderer } from "@openpaths/coding-agent/tools/gh-renderer";
import { ToolError } from "@openpaths/coding-agent/tools/tool-errors";
...
import {
	...
	xdevDocsAll,
	xdevEntries,
} from "@openpaths/coding-agent/tools/xdev";
