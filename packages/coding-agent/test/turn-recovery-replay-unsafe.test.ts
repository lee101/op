...
import type { AgentMessage, SyntheticToolResultDetails } from "@openpaths/agent-core";
import type { AssistantMessage, ToolResultMessage } from "@openpaths/ai";
...
import type { Model, Usage } from "@openpaths/catalog/types";
...
} from "@openpaths/coding-agent/session/turn-recovery";
...
describe("TurnRecovery replay-unsafe output classification", () => {
	...
	// call. Production shape (op.2026-08-07 log): `stopDetails.type === "refusal"`,
