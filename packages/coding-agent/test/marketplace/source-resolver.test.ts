...
import type { MarketplacePluginEntry } from "@openpaths/coding-agent/extensibility/plugins/marketplace";
import { resolvePluginSource } from "@openpaths/coding-agent/extensibility/plugins/marketplace";
...
describe("resolvePluginSource", () => {
	...
	beforeEach(() => {
		tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "op-src-res-test-"));
	});
