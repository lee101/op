...
import type { StatusLineSettings } from "@openpaths/coding-agent/modes/components/status-line";
...
import type { GitHeadState, GitRefHead, GitRepository } from "@openpaths/coding-agent/utils/git";
