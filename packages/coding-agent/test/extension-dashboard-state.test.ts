...
import { applyDisabledExtensionsToState } from "@openpaths/coding-agent/modes/components/extensions/state-manager";
import type { DashboardState, Extension } from "@openpaths/coding-agent/modes/components/extensions/types";
