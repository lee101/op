...
import { searchSearXNG } from "@openpaths/coding-agent/web/search/providers/searxng";
...
describe("SearXNG web search provider", () => {
	...
	it("demotes engine-hostile operators while keeping bare-domain site: filters", async () => {
		...
		await searchSearXNG({
			query: "site:github.com/lee101/op inurl:releases site:github.com 17.1.1 release",
			fetch: fetchMock,
		});

		expect(captured.q).toBe("17.1.1 release github.com/lee101/op releases site:github.com");
	});
