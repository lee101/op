...
import type { AuthStorage, CredentialOriginKind, FetchImpl } from "@openpaths/ai";
...
import { searchXAI, XAIProvider } from "@openpaths/coding-agent/web/search/providers/xai";
