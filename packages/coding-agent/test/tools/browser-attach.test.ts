...
} from "@openpaths/coding-agent/tools/browser/attach";
import {
	acquireBrowser,
	type BrowserHandle,
	normalizeConnectedCdpUrl,
	releaseBrowser,
} from "@openpaths/coding-agent/tools/browser/registry";
import { acquireTab } from "@openpaths/coding-agent/tools/browser/tab-supervisor";
