...
import { handleAur } from "@openpaths/coding-agent/web/scrapers/aur";
import { handleBrew } from "@openpaths/coding-agent/web/scrapers/brew";
import { handleMaven } from "@openpaths/coding-agent/web/scrapers/maven";
import { handleNuGet } from "@openpaths/coding-agent/web/scrapers/nuget";
import { handlePackagist } from "@openpaths/coding-agent/web/scrapers/packagist";
import { handleRubyGems } from "@openpaths/coding-agent/web/scrapers/rubygems";
