...
import { handleArtifactHub } from "@openpaths/coding-agent/web/scrapers/artifacthub";
import { handleCoinGecko } from "@openpaths/coding-agent/web/scrapers/coingecko";
import { handleDiscogs } from "@openpaths/coding-agent/web/scrapers/discogs";
