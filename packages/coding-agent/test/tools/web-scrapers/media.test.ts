...
import { handleHuggingFace } from "@openpaths/coding-agent/web/scrapers/huggingface";
import { handleSpotify } from "@openpaths/coding-agent/web/scrapers/spotify";
import { handleVimeo } from "@openpaths/coding-agent/web/scrapers/vimeo";
