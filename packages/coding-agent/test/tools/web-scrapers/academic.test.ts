...
import { handleArxiv } from "@openpaths/coding-agent/web/scrapers/arxiv";
import { handleIacr } from "@openpaths/coding-agent/web/scrapers/iacr";
import { handlePubMed } from "@openpaths/coding-agent/web/scrapers/pubmed";
import { handleSemanticScholar } from "@openpaths/coding-agent/web/scrapers/semantic-scholar";
import type { RenderResult } from "@openpaths/coding-agent/web/scrapers/types";
