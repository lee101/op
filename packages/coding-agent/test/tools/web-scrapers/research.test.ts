...
import { handleBiorxiv } from "@openpaths/coding-agent/web/scrapers/biorxiv";
import { handleOpenLibrary } from "@openpaths/coding-agent/web/scrapers/openlibrary";
import { handleWikidata } from "@openpaths/coding-agent/web/scrapers/wikidata";
