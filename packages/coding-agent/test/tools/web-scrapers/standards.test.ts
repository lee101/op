...
import { handleCheatSh } from "@openpaths/coding-agent/web/scrapers/cheatsh";
import { handleRfc } from "@openpaths/coding-agent/web/scrapers/rfc";
import { handleTldr } from "@openpaths/coding-agent/web/scrapers/tldr";
