...
import { handleChocolatey } from "@openpaths/coding-agent/web/scrapers/chocolatey";
import { handleDockerHub } from "@openpaths/coding-agent/web/scrapers/dockerhub";
import { handleHackage } from "@openpaths/coding-agent/web/scrapers/hackage";
import { handleMetaCPAN } from "@openpaths/coding-agent/web/scrapers/metacpan";
import { handleRepology } from "@openpaths/coding-agent/web/scrapers/repology";
import { handleTerraform } from "@openpaths/coding-agent/web/scrapers/terraform";
