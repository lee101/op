...
import { handleCratesIo } from "@openpaths/coding-agent/web/scrapers/crates-io";
import { handleGoPkg } from "@openpaths/coding-agent/web/scrapers/go-pkg";
import { handleHex } from "@openpaths/coding-agent/web/scrapers/hex";
import { handleNpm } from "@openpaths/coding-agent/web/scrapers/npm";
import { handlePubDev } from "@openpaths/coding-agent/web/scrapers/pub-dev";
import { handlePyPI } from "@openpaths/coding-agent/web/scrapers/pypi";
