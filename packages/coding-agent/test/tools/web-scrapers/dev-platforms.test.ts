...
import { handleDevTo } from "@openpaths/coding-agent/web/scrapers/devto";
import { handleGitLab } from "@openpaths/coding-agent/web/scrapers/gitlab";
import { handleHackerNews } from "@openpaths/coding-agent/web/scrapers/hackernews";
import { handleLobsters } from "@openpaths/coding-agent/web/scrapers/lobsters";
