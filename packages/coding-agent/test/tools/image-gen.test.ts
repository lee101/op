...
import type { CustomToolContext } from "@openpaths/coding-agent/extensibility/custom-tools";
import type { ReadonlySessionManager } from "@openpaths/coding-agent/session/session-manager";
import {
	getImageGenTools,
	getImageGenToolsWithRegistry,
	imageGenTool,
	setImageProviderOrder,
} from "@openpaths/coding-agent/tools/image-gen";
import { removeWithRetries, USER_AGENT } from "@openpaths/utils";
