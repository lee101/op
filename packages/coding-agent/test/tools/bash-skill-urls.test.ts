...
import { type ResolveContext, resolveLocalUrlToPath } from "@openpaths/coding-agent/internal-urls";
import { expandInternalUrls, expandSkillUrls } from "@openpaths/coding-agent/tools/bash-skill-urls";
