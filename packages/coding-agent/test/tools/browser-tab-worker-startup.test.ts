...
import type { ReadyInfo, WorkerInbound, WorkerOutbound } from "@openpaths/coding-agent/tools/browser/tab-protocol";
import { initializeTabWorkerForTest } from "@openpaths/coding-agent/tools/browser/tab-supervisor";
