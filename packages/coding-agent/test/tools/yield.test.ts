...
import type { Model, Tool, ToolCall } from "@openpaths/ai/types";
import { enforceStrictSchema } from "@openpaths/ai/utils/schema";
...
import { YieldTool } from "@openpaths/coding-agent/tools/yield";
