...
import { createAutoresearchExtension } from "@openpaths/coding-agent/autoresearch";
import { closeAllAutoresearchStorages } from "@openpaths/coding-agent/autoresearch/storage";
import type {
...
describe("autoresearch before_agent_start handler", () => {
	...
	beforeEach(() => {
		...
		process.env.OP_AUTORESEARCH_DB_DIR = dbDir.path();
