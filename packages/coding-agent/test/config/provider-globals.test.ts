...
import { applyProviderGlobalsFromSettings } from "@openpaths/coding-agent/config/provider-globals";
import * as imageGen from "@openpaths/coding-agent/tools/image-gen";
import * as webSearch from "@openpaths/coding-agent/web/search";
