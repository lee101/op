...
import { Agent, isSoftToolRequirement } from "@openpaths/agent-core";
...
import { dispatchResolutionDevice, queueResolveHandler } from "@openpaths/coding-agent/tools/resolve";
import { buildNamedToolChoice } from "@openpaths/coding-agent/utils/tool-choice";
