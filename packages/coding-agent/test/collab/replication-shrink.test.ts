...
import { importRoomKey } from "@openpaths/coding-agent/collab/crypto";
...
} from "@openpaths/coding-agent/collab/replication-shrink";
...
/**
 * Single-room relay mirroring the op-collab-relay forwarding contract, with
