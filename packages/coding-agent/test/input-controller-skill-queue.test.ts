...
import type { CompactionQueuedMessage, InteractiveModeContext } from "@openpaths/coding-agent/modes/types";
...
import { SKILL_PROMPT_MESSAGE_TYPE, type SkillPromptDetails } from "@openpaths/coding-agent/session/messages";
