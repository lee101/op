...
import type { AssistantMessage, Message, ThinkingContent } from "@openpaths/ai";
import {
	createMockModel,
	type MockContent,
	type MockModel,
...
import { CheckpointTool, RewindTool, type ToolSession } from "@openpaths/coding-agent/tools";
