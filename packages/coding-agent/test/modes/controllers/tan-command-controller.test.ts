...
import type { AssistantMessage, Model } from "@openpaths/ai";
import type { AsyncJobRegisterOptions } from "@openpaths/coding-agent/async/job-manager";
import { Settings } from "@openpaths/coding-agent/config/settings";
import { resolveLocalRoot } from "@openpaths/coding-agent/internal-urls/local-protocol";
import { TanCommandController } from "@openpaths/coding-agent/modes/controllers/tan-command-controller";
...
function createContext(overrides?: {
	...
	const tempDir = TempDir.createSync("@op-tan-controller-");
