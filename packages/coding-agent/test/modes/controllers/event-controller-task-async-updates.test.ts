...
import type { ToolExecutionComponent } from "@openpaths/coding-agent/modes/components/tool-execution";
...
import type { TaskToolDetails } from "@openpaths/coding-agent/task/types";
import type { BashToolDetails } from "@openpaths/coding-agent/tools/bash";
