...
import type { AssistantThinkingRenderer } from "@openpaths/coding-agent/extensibility/extensions";
import { AssistantMessageComponent } from "@openpaths/coding-agent/modes/components/assistant-message";
import { clearMermaidCache } from "@openpaths/coding-agent/modes/theme/mermaid-cache";
import { initTheme } from "@openpaths/coding-agent/modes/theme/theme";
import { ImageProtocol, setTerminalImageProtocol, TERMINAL, Text } from "@openpaths/tui";
