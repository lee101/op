...
import { createCompactionSummaryMessage } from "@openpaths/agent-core/compaction";
import type { ImageContent } from "@openpaths/ai";
import { CompactionSummaryMessageComponent } from "@openpaths/coding-agent/modes/components/compaction-summary-message";
