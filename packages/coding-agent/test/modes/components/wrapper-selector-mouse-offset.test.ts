...
import { PluginSelectorComponent } from "@openpaths/coding-agent/modes/components/plugin-selector";
import { QueueModeSelectorComponent } from "@openpaths/coding-agent/modes/components/queue-mode-selector";
import { ThemeSelectorComponent } from "@openpaths/coding-agent/modes/components/theme-selector";
import { ThinkingSelectorComponent } from "@openpaths/coding-agent/modes/components/thinking-selector";
import { initTheme } from "@openpaths/coding-agent/modes/theme/theme";
import type { SgrMouseEvent } from "@openpaths/tui";
