...
import type { ExtensionAskDialogQuestion } from "@openpaths/coding-agent/extensibility/extensions/types";
import { AskDialogComponent } from "@openpaths/coding-agent/modes/components/ask-dialog";
