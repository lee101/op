...
import { resetActiveRulesForTests, setActiveRules } from "@openpaths/coding-agent/capability/rule";
...
import {
	...
	isInternalUrlPrefix,
} from "@openpaths/coding-agent/modes/internal-url-autocomplete";
import { PromptActionAutocompleteProvider } from "@openpaths/coding-agent/modes/prompt-action-autocomplete";
