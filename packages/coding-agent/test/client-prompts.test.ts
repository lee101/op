...
import { getPrompt, listPrompts, serverSupportsPrompts } from "@openpaths/coding-agent/mcp/client";
import type { MCPGetPromptResult, MCPPrompt, MCPPromptsListResult } from "@openpaths/coding-agent/mcp/types";
