...
// `op-legacy-pi-modules` exists only in compiled binaries via the build plugin;
...
async function cleanBundleOutputs(): Promise<void> {
	// dist/ is shared with the dev binary (dist/op); only remove assets
...
async function main(): Promise<void> {
	...
	// SDK consumers importing `@openpaths/coding-agent/*` (TypeScript source, no
	// build-time embed) can still resolve op:// docs (see src/internal-urls/docs-index.ts).
	try {
