 ...
 *
 * Usage:
 *   op --hook examples/hooks/custom-compaction.ts
 */
import { complete, getModel } from "@openpaths/ai";
import type { HookAPI } from "@openpaths/coding-agent";
import { convertToLlm, serializeConversation } from "@openpaths/coding-agent";
