 ...
 *
 * Usage:
 * 1. Copy this file to ~/.op/agent/extensions/ (legacy: ~/.pi/agent/extensions/) or your project's .op/extensions/
 * 2. Use /tools to open the tool selector
 */
import type { ExtensionAPI, ExtensionContext } from "@openpaths/coding-agent";
import { getSettingsListTheme } from "@openpaths/coding-agent";
import { Container, type SettingItem, SettingsList } from "@openpaths/tui";
