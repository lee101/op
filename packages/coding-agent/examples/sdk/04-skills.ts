 ...
 */
import { createAgentSession, discoverSkills, SessionManager, type Skill } from "@openpaths/coding-agent";

// Discover all skills from cwd/.op/skills, ~/.op/agent/skills, etc.
