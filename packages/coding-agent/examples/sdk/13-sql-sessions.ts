 ...
 * `BlobStore` keep writing to `~/.op/agent/...`. Reach for object storage
 * if you need those off-host too.
 */

import { createAgentSession, SessionManager, SqlSessionStorage } from "@openpaths/coding-agent";
import { SQL } from "bun";
...
const storage = await SqlSessionStorage.create({
	client,
	table: "op_session_files", // optional, this is the default
