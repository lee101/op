 ...
 * - ~/.op/agent/extensions/ (legacy: ~/.pi/agent/extensions/)
 * - <cwd>/.op/extensions/ (legacy: <cwd>/.pi/extensions/)
...
//   1. Place extension files in ~/.op/agent/extensions/ or .op/extensions/
