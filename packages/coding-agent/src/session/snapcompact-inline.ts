...
import type { Context, ImageContent, Model, TextContent, ToolResultMessage, UserMessage } from "@openpaths/ai";
...
// Per-provider image-count budgets live in @openpaths/snapcompact
