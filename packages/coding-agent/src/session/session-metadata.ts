import { deriveClaudeDeviceId } from "@openpaths/ai";
import { getInstallId } from "@openpaths/utils";
...
export function buildSessionMetadata(
	...
	if (provider === "anthropic") {
		...
		if (typeof accountUuid === "string" && accountUuid.length > 0) {
			...
			// identifier. Include both op's persistent install id and the Claude
