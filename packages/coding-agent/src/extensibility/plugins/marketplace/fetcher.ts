...
/**
 * Catalog paths tried in priority order: op-namespaced override first, then
 * the Claude Code-compatible fallback so existing marketplaces keep loading.
 */
const CATALOG_RELATIVE_PATHS: readonly string[] = [".op-plugin/marketplace.json", ".claude-plugin/marketplace.json"];
