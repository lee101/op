...
import type { CredentialDisabledEvent, ImageContent, Model, ProviderResponseMetadata } from "@openpaths/ai";
...
export class ExtensionRunner {
	...
	static readonly #RESERVED_SHORTCUTS: Record<string, true> = {
		...
		"ctrl+g": true,
		"alt+m": true,
		// Default chords for `app.message.followUp` (Ctrl+Q: Windows Terminal can't
		// deliver Ctrl+Enter, #1903; Tab: queue chord).
		"ctrl+q": true,
		tab: true,
		"shift+tab": true,
		"shift+ctrl+p": true,
