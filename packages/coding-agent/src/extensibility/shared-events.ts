...
import type { CompactionPreparation, CompactionResult } from "@openpaths/agent-core/compaction";
import type { AssistantRetryRecovery, ImageContent, TextContent, ToolResultMessage } from "@openpaths/ai";
...
export interface SessionStopEventResult {
	...
	continue?: boolean;
	/** OP-native model-visible context for the continuation */
