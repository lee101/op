...
import type { AgentEvent, AgentIdentity, AgentMessage, AgentTelemetryConfig } from "@openpaths/agent-core";
import { EventLoopKeepalive, recordHandoff, resolveTelemetry } from "@openpaths/agent-core";
import type { Api, Model, ServiceTierByFamily, Usage } from "@openpaths/ai";
import { logger, popLoopPhase, prompt, pushLoopPhase, untilAborted } from "@openpaths/utils";
...
export interface ExecutorOptions {
	 ...
	 * `.op/tools/` FS scan in the subagent; the subagent then re-binds each
