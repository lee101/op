...
import { isRecord, logger, postmortem, ptree, setProcessName } from "@openpaths/utils";
...
export class LspMuxServer {
	...
	async #handleServerRequest(server: ServerInstance, message: LspJsonRpcRequest): Promise<void> {
		...
		// Client-side effects such as applyEdit must reach exactly one, most recently active op.
