 ...
 * each concurrent OP link its own language-server process, then retains idle
 ...
 */
export const MUX_CONNECT_METHOD = "op/muxConnect";
 ...
 */
export const MUX_PING_METHOD = "op/muxPing";
 ...
 */
export const MUX_RESTART_METHOD = "op/muxRestartServer";
