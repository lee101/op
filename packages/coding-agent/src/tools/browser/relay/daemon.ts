 ...
 * the user run `op browser-relay` by hand, the relay kind lazily starts one
...
export const RELAY_DAEMON_NAME = "op.browser.relay";
const RELAY_BROKER_SCOPE = "browser-relay";
/** Matches the serve banner (`op browser relay listening on http://…`). */
