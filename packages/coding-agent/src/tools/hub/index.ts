...
const hubSchema = type({
	...
	"persist?": type("boolean").describe("start: survive the last op client exiting; default false"),
	"detached?": type("boolean").describe(
		"start: survive every op and broker exit; implies persist and disables PTY input",
	),
