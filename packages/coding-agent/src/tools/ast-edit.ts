...
import { type AstReplaceChange, type AstReplaceFileChange, astEdit } from "@openpaths/natives";
import type { Component } from "@openpaths/tui";
import { replaceTabs, Text } from "@openpaths/tui";
import { $envpos, prompt, untilAborted } from "@openpaths/utils";
