...
import type { AgentTool, AgentToolResult, ToolTier } from "@openpaths/agent-core";
...
export class SecurityScanTool implements AgentTool<typeof securityScanSchema, SecurityScanToolDetails> {
	...
	readonly summary = "Run OP-native scans and explicit Codex Security cloud operations";
