...
import { formatHashlineHeader, stripHashlinePrefixes } from "@openpaths/hashline";
...
import { isEnoent, isRecord, prompt, untilAborted } from "@openpaths/utils";
...
export class WriteTool implements AgentTool<typeof writeSchema, WriteToolDetails> {
	...
	async execute(
		...
		return untilAborted(signal, async () => {
			...
			// artifacts such as local:// plans are owned by OP, not the editor.
