...
interface MCPServerConfigBase {
	 ...
	 * `./request-id`.
	 *
	 * OP-specific, so only the OP-owned discovery providers parse it (native,
	 * standalone `mcp.json`, OP plugins). Providers that translate another
...
export const MCP_CONFIG_SCHEMA_URL =
	"https://raw.githubusercontent.com/lee101/op/main/packages/coding-agent/src/config/mcp-schema.json";
