...
import { BracketedPasteHandler } from "@openpaths/tui/bracketed-paste";
 ...
 * argument list, tolerating both the op `(theme)` and upstream-pi
...
export class CustomEditor extends Editor {
	 ...
	 * the upstream-pi `(tui, theme, keybindings)` convention. Undefined for op's
	...
	/**
	 * Accept both the op constructor convention — `new CustomEditor(theme)` —
