import { type Component, Container, Markdown } from "@openpaths/tui";
import { formatBytes } from "@openpaths/utils";
...
// synthesized arrow keys on op's pty, slamming the editor caret to column 0
// (#8030, #6115).
//
