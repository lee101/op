import { countTokens } from "@openpaths/agent-core";
import type { CompactionSettings } from "@openpaths/agent-core/compaction";
import { effectiveReserveTokens, estimateTokens, resolveThresholdTokens } from "@openpaths/agent-core/compaction";
import type { Tool as AiTool, Model } from "@openpaths/ai";
import { toolWireSchema } from "@openpaths/ai/utils/schema";
import { formatNumber } from "@openpaths/utils";
