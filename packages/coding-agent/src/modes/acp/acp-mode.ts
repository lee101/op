...
import { AgentSideConnection, ndJsonStream, type Stream } from "@openpaths/utils/acp";
...
export async function runAcpMode(createSession: AcpSessionFactory, initialSession?: AgentSession): Promise<void> {
	// Humans who run `op acp` by hand see a silent process and assume it is
