 ...
 *
 * Internal URLs (`agent://`, `artifact://`, `history://`, `issue://`, `local://`, `mcp://`, `memory://`, `op://`, `pr://`, `rule://`, `security://`, `skill://`, `ssh://`, `vault://`, and `xd://`) are resolved by tools like read,
...
export interface ResolveContext {
	 ...
	 * [#1608](https://github.com/lee101/op/issues/1608).
	 */
