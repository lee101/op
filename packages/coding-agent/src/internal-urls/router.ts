/**
 * Internal URL router for internal protocols (`agent://`, `artifact://`, `history://`, `issue://`, `local://`, `mcp://`, `memory://`, `op://`, `pr://`, `rule://`, `security://`, `skill://`, `ssh://`, `vault://`, and `xd://`).
 *
...
import { OpProtocolHandler } from "./op-protocol";
...
export class InternalUrlRouter {
	...
	constructor() {
		this.register(new OpProtocolHandler());
		...
		// Reserved OP-owned security-analysis namespace; vendor adapters normalize into its store.
