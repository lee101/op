...
Managed skills: `SKILL.md` in isolated `~/.op/agent/managed-skills`; surfaced in future sessions like other skills.
...
Isolation: managed skills ONLY writable skills. NEVER edit user-authored skills in `~/.op/agent/skills` or `.op/skills`.
