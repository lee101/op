Publish current OP-native security scan's canonical result.
...
Tool: validates, fingerprints, assigns OP-owned IDs, writes canonical security store, creates SARIF.
