 ...
 *
 * Handles `op setup` for onboarding and `op setup <component>` for optional dependencies.
 */
import * as path from "node:path";
import { APP_NAME, getProjectDir, getPythonEnvDir } from "@openpaths/utils";
...
// package dependencies beyond a working interpreter. `op setup python --check`
...
/**
 * Unified `op setup speech` flow. Drives every {@link SpeechComponent} through
