...
import { $which, getRemoteHostDir, getSshControlDir, isEnoent, logger, postmortem, ptree } from "@openpaths/utils";
...
export interface SSHHostInfo {
	...
	shell: SSHHostShell;
	/**
	 * Shell name OP verified can execute the POSIX transfer snippets
