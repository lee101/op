 ...
 */
import { type ApiKey, type FetchImpl, withAuth } from "@openpaths/ai";
import type { Api, Model, RemoteCompactionConfig } from "@openpaths/ai/types";
 ...
 * `qwen-template-false` dialect; op emits `preserve_thinking` inside
