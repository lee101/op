...
import { configureProviderMaxInFlightRequests } from "@openpaths/ai/stream";
import {
	getAgentDbPath,
	getAgentDir,
...
export class Settings {
	...
	#project: RawSettings = {};
	/** Last successfully loaded native .op/config.yml contents. */
	...
	async #loadProjectSettings(): Promise<RawSettings> {
		...
		const projectConfigPath = path.join(this.#cwd, ".op", "config.yml");
