import type { Api, Model, ModelSpec, RemoteCompactionConfig } from "@openpaths/ai/types";
...
import { getVariantAliasSources, resolveVariantAlias } from "@openpaths/catalog/variant-collapse";
