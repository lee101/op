...
import { Effort, type Model, THINKING_EFFORTS } from "@openpaths/ai";
import { clampThinkingLevelForModel, getSupportedEfforts } from "@openpaths/catalog/model-thinking";
