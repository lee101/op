...
import { isEisdir, isEnoent, logger, postmortem } from "@openpaths/utils";
 ...
 * deleting a scope whose owning op process is mid-startup (token written, broker
...
/** Handle keeping one op process registered in a project daemon scope. */
...
/** Register this op process so project daemons survive while it remains alive. */
...
/** Return whether a registered op process in this runtime directory is still alive. */
