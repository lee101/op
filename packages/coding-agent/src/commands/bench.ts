...
export default class Bench extends Command {
	...
	static examples = [
		"# Compare two models\n  op bench anthropic/claude-opus-4-5 openai/gpt-5.2",
		"# Fuzzy selectors work\n  op bench opus sonnet",
		"# Average over 3 runs each\n  op bench opus gpt-5.2 --runs 3",
		"# Force priority serving tier\n  op bench openai-codex/gpt-5.5:low --runs 10 --service-tier priority",
		"# Measure one cold/warm prompt-cache pair\n  op bench openai/gpt-5.6 --cache --json",
	];
