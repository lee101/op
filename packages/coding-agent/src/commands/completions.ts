/**
 * `op completions <bash|zsh|fish>` — print a shell completion script.
 *
...
import { APP_NAME, VERSION } from "@openpaths/utils";
import { Args, type CliConfig, Command, type CommandCtor } from "@openpaths/utils/cli";
