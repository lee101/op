/**
 * Shared wire types for the op collab live-session protocol.
 *
 * Dependency-free JSON shapes produced by `@openpaths/coding-agent`
...
export const DEFAULT_RELAY_URL = "wss://my.openpaths.io";

/** Default share viewer/upload base; `/share` links resolve against `<base>/<id>#<key>`. */
export const DEFAULT_SHARE_URL = "https://my.openpaths.io/s";
