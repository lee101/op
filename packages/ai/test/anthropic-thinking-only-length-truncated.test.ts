...
import type { AssistantMessage, Message, Model, UserMessage } from "@openpaths/ai/types";
 ...
 *
 * Reproduces the shape captured in `~/.op/logs/http-400-requests/*.json` after Claude
