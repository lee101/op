 ...
 * `reasoning_content` even though op already sends it on the wire (the Kimi
...
import type { AssistantMessage, Context, FetchImpl, Model, ModelSpec } from "@openpaths/ai/types";
