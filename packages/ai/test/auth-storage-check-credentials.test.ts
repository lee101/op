 ...
 * that powers `op auth-gateway check`. Contract under test:
 *
...
import type { UsageProvider } from "@openpaths/ai/usage";
import * as claudeUsage from "@openpaths/ai/usage/claude";
import { ollamaCloudUsageProvider } from "@openpaths/ai/usage/ollama";
