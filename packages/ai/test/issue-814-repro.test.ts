...
import type { AssistantMessage, Model, ModelSpec, ToolResultMessage, UserMessage } from "@openpaths/ai/types";
 ...
 * carries `tool_use_id`. As a workaround, OP must include `id` (aliased to
