...
import type { Api, Context, Model, ModelSpec } from "@openpaths/ai/types";
import { buildModel } from "@openpaths/catalog/build";
import { COPILOT_API_HEADERS } from "@openpaths/catalog/wire/github-copilot";
 ...
 * hint (an openpaths extension that preserves native-resolution snapcompact
