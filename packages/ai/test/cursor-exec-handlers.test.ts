...
import { streamCursor as lazyStreamCursor, setCursorProviderModule } from "@openpaths/ai/providers/register-builtins";
import type { AssistantMessage, Context, CursorExecHandlers, Model, ToolResultMessage } from "@openpaths/ai/types";
...
import type { McpResult, ReadResult } from "@openpaths/catalog/discovery/cursor-gen/agent_pb";
import {
