...
import type { AssistantMessage, Context, FetchImpl, Model, SimpleStreamOptions, Usage } from "@openpaths/ai/types";
import { buildOpenAICompat } from "@openpaths/catalog/compat/openai";
