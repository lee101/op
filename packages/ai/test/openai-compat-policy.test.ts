...
import type { ResponseCreateParamsStreaming } from "@openpaths/ai/providers/openai-responses-wire";
import {
...
import type { Model, ModelSpec, OpenAICompat } from "@openpaths/ai/types";
