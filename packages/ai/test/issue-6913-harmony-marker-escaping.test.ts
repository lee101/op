...
import type { ResponseInput } from "@openpaths/ai/providers/openai-responses-wire";
import { buildResponsesInput } from "@openpaths/ai/providers/openai-shared";
import type { AssistantMessage, Context, ToolResultMessage, UserMessage } from "@openpaths/ai/types";
import { createOpenAIResponsesHistoryPayload } from "@openpaths/ai/utils";
...
function harmonyPoisonedContext(): { context: Context; user: UserMessage; toolResult: ToolResultMessage } {
	...
	const toolResult: ToolResultMessage = {
		...
		toolName: "grep",
		isError: false,
		content: [{ type: "text", text: `op://toolconv/harmony.md: ${MARKER}\nmore docs` }],
		timestamp: 0,
	};
