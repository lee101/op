/**
 * Test helper for resolving API keys from ~/.op/agent/testauth.db
 *
...
import { getOAuthApiKey } from "@openpaths/ai/oauth";
import type { OAuthCredentials, OAuthProvider } from "@openpaths/ai/oauth/types";
import { $flag, getAgentDir, isEnoent } from "@openpaths/utils";
...
/**
 * Resolve API key for a provider from ~/.op/agent/testauth.db
 *
