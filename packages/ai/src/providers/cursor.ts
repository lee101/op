...
import type { ConversationStep, McpToolDefinition } from "@openpaths/catalog/discovery/cursor-gen/agent_pb";
import {
...
import { isKimiK3ModelId } from "@openpaths/catalog/identity";
