 ...
 * (containerized op, robomp's sidecar auth-gateway).
 ...
 * `SimpleStreamOptions` from older / newer op builds without per-version
 * conditionals.
 */
 ...
 * targets (containerized op → host gateway, robomp slot → op-auth-gateway
