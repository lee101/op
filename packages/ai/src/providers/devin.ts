...
} from "@openpaths/catalog/discovery/devin-gen/exa/api_server_pb/api_server_pb";
import {
	GetUserJwtRequestSchema,
	GetUserJwtResponseSchema,
} from "@openpaths/catalog/discovery/devin-gen/exa/auth_pb/auth_pb";
import {
	CacheControlType,
...
} from "@openpaths/catalog/discovery/devin-gen/exa/chat_pb/chat_pb";
import {
	ChatMessageSource,
	type ChatToolCall,
	ChatToolCallSchema,
	...
	MetadataSchema,
	StopReason,
} from "@openpaths/catalog/discovery/devin-gen/exa/codeium_common_pb/codeium_common_pb";
import { calculateCost } from "@openpaths/catalog/models";
import { logger, parseStreamingJson, parseStreamingJsonThrottled } from "@openpaths/utils";
...
/** Map op `Message` history onto Cascade `ChatMessagePrompt`s (USER / SYSTEM / TOOL channels). */
