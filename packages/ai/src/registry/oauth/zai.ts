...
/** OP's own key name so sign-in never mutates ZCode's `zcode-api-key`. */
const KEY_NAME = "openpaths";
 ...
 * `getCustomerInfo` → find/create the OP-named key → obtain its secret →
