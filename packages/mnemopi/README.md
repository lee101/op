...
Local SQLite memory engine for OpenPaths agents.
...
```ts
import { Mnemopi } from "@openpaths/mnemopi";
...
The OpenPaths coding-agent wrapper adds `mnemopi.scoping` on top of those constructor options:
