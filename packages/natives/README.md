...
```typescript
import { encodeSixel, grep, pdfToMarkdown } from "@openpaths/natives";
...
`@openpaths/natives` publishes a small core package plus generated
...
npm/<platform>-<arch>/   # Generated at publish time, not committed
  package.json           # @openpaths/natives-<platform>-<arch>
