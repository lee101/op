 ...
 * link/envelope half of `@openpaths/coding-agent/src/collab/protocol.ts`;
...
import type { ParsedCollabLink } from "@openpaths/wire";
import {
	DEFAULT_RELAY_URL,
...
export { COLLAB_PROTO } from "@openpaths/wire";
