/**
 * `<op-tool-view>` — web-component wrapper around ToolView for non-React
...
export class OpToolViewElement extends HTMLElement {
	#root: Root | null = null;
...
export function defineToolViewElement(tag = "op-tool-view"): void {
	if (!customElements.get(tag)) customElements.define(tag, OpToolViewElement);
}
