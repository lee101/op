import { encodeSixel } from "@openpaths/natives";
import { $env, isBunTestRuntime, isTerminalHeadless } from "@openpaths/utils";
...
const CMUX_NOTIFICATION_TITLE = "OpenPaths";
...
const OSC99_APP_NAME = "OpenPaths";
...
function osc99Id(id: string | undefined): string {
	return sanitizeOsc99Id(id) || `op-${nextOsc99NotificationId++}`;
}
