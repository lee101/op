...
import { isTerminalHeadless, setTerminalHeadless } from "@openpaths/utils";
...
describe("ProcessTerminal headless suppression", () => {
	...
	// #6374: arrows stopped working inside op and stayed broken in the shell
	// after exit — a missing cursor-key/keypad reset. op owns the TTY and emits
