...
import { type Component, Container, type Focusable, type OverlayFocusOwner, TUI } from "@openpaths/tui";
import type { Terminal, TerminalAppearance } from "@openpaths/tui/terminal";
