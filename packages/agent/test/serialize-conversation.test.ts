...
import { serializeConversation, serializeConversationForSummary } from "@openpaths/agent-core/compaction";
import type { AssistantMessage, Message, ToolResultMessage, Usage } from "@openpaths/ai";
