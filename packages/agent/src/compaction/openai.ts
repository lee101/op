...
import { applyCodexResponsesLiteShape } from "@openpaths/ai/providers/openai-codex/request-transformer";
import {
	createOpenAICodexCompactionRequestContext,
	createOpenAICodexCompatibilityMetadata,
	getCodexAttestationHeader,
} from "@openpaths/ai/providers/openai-codex-responses";
import { parseAzureDeploymentNameMap, parseTextSignature } from "@openpaths/ai/providers/openai-shared";
import { transformMessages } from "@openpaths/ai/providers/transform-messages";
import type {
	Api,
	AssistantMessage,
...
} from "@openpaths/ai/utils";
import { captureOpenAIHttpError } from "@openpaths/ai/utils/openai-http";
import {
	CODEX_BASE_URL,
	getCodexAccountId,
...
import { $env, isRecord, logger, prompt, stringifyJson, structuredCloneJSON } from "@openpaths/utils";
 ...
 * either a purpose-built op summarizer (`{systemPrompt, prompt}` → `{summary}`)
 ...
 * issue #4630: without this, the op payload was rejected with
