...
`@openpaths/ai` exposes one unified schema normalizer that providers consume
...
All exports live under `@openpaths/ai/utils/schema`:
...
- `StringEnum` helper — use `type.enumerated(...)`; optype emits
