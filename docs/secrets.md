...
| Level   | Path                       | Purpose                     |
| ------- | -------------------------- | --------------------------- |
| Global  | `~/.op/agent/secrets.yml` | Secrets across all projects |
| Project | `<cwd>/.op/secrets.yml`   | Project-specific secrets    |
