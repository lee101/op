...
- syntax highlighting colors used by native highlighter (`@openpaths/natives`)
...
- default agent dir: `~/.op/agent`
- effective default file: `~/.op/agent/config.yml`
...
1. Create file in custom themes dir, e.g. `~/.op/agent/themes/my-theme.json`.
