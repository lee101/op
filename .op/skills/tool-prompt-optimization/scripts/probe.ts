 ...
 *
 * Routes through @openpaths/ai (`completeSimple`) rather than raw HTTP so model
...
import { completeSimple } from "@openpaths/ai";
import type { Api, AssistantMessage, Model } from "@openpaths/ai";
