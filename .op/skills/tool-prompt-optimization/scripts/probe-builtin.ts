...
import { toolWireSchema } from "@openpaths/ai";
import { Settings } from "@openpaths/coding-agent/config/settings";
import { BUILTIN_TOOLS, GithubTool, HIDDEN_TOOLS, IrcTool, type Tool, type ToolFactory, type ToolSession } from "@openpaths/coding-agent/tools";
