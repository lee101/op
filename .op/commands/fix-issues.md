...
2. Run `gh search prs` for issue number. Reasonable existing PR → review per `.op/commands/review-prs.md`, report `existing-pr`; do NOT create competing fix.
...
Worktree:  ~/.op/wt/.../fix-issue-<N>            (if created)
