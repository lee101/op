...
# terminal transcript.
#
# Prepare a directory (default ~/op-signing) containing:
...
#   OP_REPO=owner/repo scripts/ci-macos-upload-secrets.sh ~/op-signing
...
DIR="${DIR:-${OP_SIGNING_DIR:-$HOME/op-signing}}"
REPO="${OP_REPO:-lee101/op}"
